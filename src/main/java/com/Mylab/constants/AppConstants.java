...
public class AppConstants {
	...
	public static final String CHANGE_STATUS_SUCC="planStatusChangeSucc";
	
	public static final String CHANGE_STATUS_FAIL ="planStatusChangeFail";
